...
#Updater 
local-miui-modified-apps := MiuiSystemUI ThemeManager MiuiHome
...
local-remove-apps := AllBackup SystemUI SetupWizard Cloud NotePad HwIME Superuser MusicFx Launcher2 FileManager HwOUC \
	rootexplorer GenieWidget GalleryGoogle CalendarGoogle GooglePackageVerifier GooglePackageVerifierUpdater \
	GoogleTTS GooglePlayMusic TotemWeather Trebuchet ToolBox Maps Talk Vending Gallery2 GoogleTranslate \
	PinyinIME Street PhaseBeam VoiceSearch
